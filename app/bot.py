...
async def action_instruction(callback: CallbackQuery, state: FSMContext):
    await smart_send(callback, 
        ...
        "4️⃣ <b>Статусы</b> — руководители обновляют статусы проблем\n"
        "5️⃣ <b>Обратная связь</b> — напишите отзыв о работе бота\n\n"
        "Подробная инструкция: https://example.com/instruction",
        parse_mode="HTML",
